...
GetLoginAuthResponse getLoginAuthResponseFromJson(String str) =>
    GetLoginAuthResponse.fromJson(json.decode(str));

String getLoginAuthResponseToJson(GetLoginAuthResponse data) =>
...
class GetLoginAuthResponse {
  ...
  GetLoginAuthResponse({required this.meta, required this.data});

  factory GetLoginAuthResponse.fromJson(Map<String, dynamic> json) =>
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    kelengkapanJobseeker: KelengkapanJobseeker.fromJson(
      json["kelengkapanJobseeker"],
    ),
  );
...
class KelengkapanJobseeker {
  ...
  factory KelengkapanJobseeker.fromJson(Map<String, dynamic> json) =>
      KelengkapanJobseeker(
...
class Kelengkapan {
  ...
  Kelengkapan({required this.terpenuhi, required this.total});

  factory Kelengkapan.fromJson(Map<String, dynamic> json) =>
      Kelengkapan(terpenuhi: json["terpenuhi"], total: json["total"]);

  Map<String, dynamic> toJson() => {"terpenuhi": terpenuhi, "total": total};
}
...
class Meta {
  ...
  Meta({required this.statusCode, required this.message});

  factory Meta.fromJson(Map<String, dynamic> json) =>
      Meta(statusCode: json["status_code"], message: json["message"]);
