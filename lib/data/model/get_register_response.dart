...
//
//     final getRegisterAuthResponse = getRegisterAuthResponseFromJson(jsonString);

import 'dart:convert';

GetRegisterAuthResponse getRegisterAuthResponseFromJson(String str) => GetRegisterAuthResponse.fromJson(json.decode(str));

String getRegisterAuthResponseToJson(GetRegisterAuthResponse data) => json.encode(data.toJson());

class GetRegisterAuthResponse {
    final Meta meta;
    final DataRegister data;

    GetRegisterAuthResponse({
        required this.meta,
        required this.data,
    });

    factory GetRegisterAuthResponse.fromJson(Map<String, dynamic> json) => GetRegisterAuthResponse(
